...
\Midtrans\Config::$serverKey = 'SB-Mid-server-m45d0AqjVWgNo_jhPp1LJnkl';
...
<body>
    ...
    <div class="card">
        <div class="card-header">
            <h1 id="totalbayar">Pembayaran Online Total: Rp. <?php echo isset($_SESSION['productItems']) ? number_format(array_sum(array_column($_SESSION['productItems'], 'price')), 0, ',', '.') : '0'; ?></h1>
        </div>
        <div class="card-body">
            <?php
            ...
            <?php if (isset($_SESSION['productItems'])) : ?>
                <div class="mt-4 text-end">
                    ...
                    <button type="button" class="btn btn-primary px-4 mx-1 selesai" id="saveOrder"><i class="fa fa-upload" aria-hidden="true"></i> Simpan</button>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-sdCbImuf95e9YPel"></script>
